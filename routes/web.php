...
Route::middleware('admin')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::controller(\App\Http\Controllers\PresenceController::class)->name('presences.')->group(function () {
        ...
        Route::controller(\App\Http\Controllers\EpreuveController::class)->name('sujet.')->group(function () {
            ...
            Route::get('mes-sujets', 'sujets')->name('messujets');
            Route::get('mysujet/{sujet}', 'delete')->name('mysujet');
            Route::get('supp/{sujet}', 'sujetsdelete')->name('deletesujet');
